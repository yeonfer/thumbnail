...
<head>
  ...
  <title>Download YouTube Video Thumbnail | FernandaF</title>
  <link rel="stylesheet" href="style.css">
  <!-- acesse o link pra ouvir uma das melhores melodias do mundo -->
...
<body>
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
    ...
    <div class="url-input">
      ...
      <div class="field">
        <input type="text" placeholder="https://www.youtube.com/watch?v=PdtwS1DeaxU" required>
